...
# CUDA_VISIBLE_DEVICES=2,3 uv run python main.py --model_name "Qwen/Qwen2.5-1.5B-Instruct" --judge_model_name "Qwen/Qwen2.5-1.5B-Instruct" --compare_model_name "Qwen/Qwen2.5-1.5B-Instruct" --dataset_name "debate" --evaluator "debate" --output_dir "debate_BatchComp_test" --num_train_iters 50 --eval_iterations 20 --verbose --save_steps 5 --num_chains 16 --gradient_accumulation_steps 4 --use_batch_generation 
CUDA_VISIBLE_DEVICES=2,3 uv run python main.py --model_name "Qwen/Qwen2.5-1.5B-Instruct" --judge_model_name "Qwen/Qwen2.5-1.5B-Instruct" --compare_model_name "Qwen/Qwen2.5-1.5B-Instruct" --dataset_name "debate" --evaluator "debate" --output_dir "debate_BatchComp_test" --num_train_iters 50 --eval_iterations 20 --verbose --save_steps 5 --num_chains 16 --gradient_accumulation_steps 4 --use_batch_generation  --use_batch_judge
